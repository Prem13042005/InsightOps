...
export function GoogleButton({ onClick, label = "Continue with Google" }: { onClick?: () => void; label?: string }) {
  return (
    <Button
      ...
      variant="outline"
      onClick={onClick}
      className="w-full h-10 gap-3 rounded-md bg-white border-slate-200 text-slate-800 hover:bg-slate-50 hover:border-slate-300 shadow-sm"
    >
      <svg className="h-[18px] w-[18px]" viewBox="0 0 24 24" aria-hidden>
        ...
        <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.65l3.15-3.15C17.45 2.1 14.97 1 12 1A11 11 0 0 0 2.18 7.06l3.66 2.84C6.71 7.3 9.14 5.38 12 5.38Z"/>
      </svg>
